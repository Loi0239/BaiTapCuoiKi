...
import qlhv.controller.QLLHController;

import java.awt.event.ActionListener;
import java.awt.event.ActionEvent;

public class QLLH extends JPanel {
	...
	public QLLH() {
		...
		QLLHController controller = new QLLHController(jpbTable, jbtAdd, jbtDelete, tfSearch);
